...
async def send_book(message: types.Message):
    photo_id = "AgACAgIAAxkBAAICKmazTrAVYAqhRgflca-EeOoaSrT9AAJj2jEbfKeYSc9Yzo5TZvtIAQADAgADeAADNQQ"
...
@dp.message_handler(Command("rasmlar"))
async def send_courses(message: types.Message):
    album = types.MediaGroup()
    photo1 = "AgACAgIAAxkBAAICKmazTrAVYAqhRgflca-EeOoaSrT9AAJj2jEbfKeYSc9Yzo5TZvtIAQADAgADeAADNQQ"
    photo2 = "https://avatars.githubusercontent.com/u/105547303?v=4"
    video1 = "BAACAgIAAxkBAAICQWazUXaJ55d3UWtWv7qcHYW4hJ0lAAKVUwACfKeYSRs2J3QgMWeENQQ"
